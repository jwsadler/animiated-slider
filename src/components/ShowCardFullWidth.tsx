...
const ShowCardFullWidth: React.FC<ShowCardBaseProps> = ({
  show,
  onPress,
  disabled = false,
}) => {
...
const styles = StyleSheet.create({
  ...
  imageOverlay: {
    height: 200, // Taller for full width cards
    position: 'relative',
  },
  liveBadge: {
    position: 'absolute',
  ...
  showInfo: {
    padding: 16, // More padding for full width cards
  },
  showHeader: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  userAvatar: {
    width: 16, // Slightly larger for full width
    height: 16,
    borderRadius: 8,
    marginRight: 8,
  },
  ...
  showTitle: {
    fontSize: 16, // Larger title for full width
    color: '#333333',
    fontWeight: '600',
    lineHeight: 20,
    marginBottom: 6,
...
export default ShowCardFullWidth;
